...
namespace WardrobeProject.Controllers
{
    public class ClothingTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClothingTypeID,ClothingType1")] ClothingType clothingType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClothingTypeID,ClothingType1")] ClothingType clothingType)
        {
            if (ModelState.IsValid)
            {
